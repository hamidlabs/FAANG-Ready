...
export function groupTopicsIntoPhases(topics: Topic[]): Phase[] {
  ...
  // Initialize phases
  const phaseInfo = {
    phase1: { title: 'English Communication Foundation', description: 'Master technical communication and interview skills', order_index: 1 },
    phase2: { title: 'Problem-Solving Mental Framework', description: 'Build systematic approach to algorithmic thinking', order_index: 2 },
    phase3: { title: 'Core Data Structures', description: 'Master fundamental data structures', order_index: 3 },
    phase4: { title: 'Essential Algorithms', description: 'Core sorting and searching algorithms', order_index: 4 },
    phase5: { title: 'Pattern-Based Problem Solving', description: 'Master the most important coding patterns', order_index: 5 },
    phase6: { title: 'Advanced Patterns', description: 'Dynamic programming and advanced techniques', order_index: 6 },
  };
...
*Note: Content is now loaded dynamically from the \`content/${filename.replace('/main.md', '')}\` directory.*`;
}